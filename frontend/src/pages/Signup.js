    ...
    return(
        <div className='flex justify-center items-center w-full h-screen bg-grey'>
            <form className="flex flex-col my-12 mx-auto p-5" onSubmit={ handleSubmit }>
                <h3 className='text-3xl md:text-4xl font-semibold text-primary text-center'>New to <span className='text-yellow-800'>EliteFitness</span>?</h3>
                <h3 className='text-3xl md:text-4xl font-semibold text-primary text-center pb-6'>Register free</h3>
                ...
                <input
                    ...
                    className='w-full p-3 mt-2 mb-4 min-w-[250px] md:min-w-[400px] border-2 border-solid rounded-md'
                    placeholder='Email'
                />
                <input
                    ...
                    className='w-full p-3 mt-2 mb-2 min-w-[250px] md:min-w-[400px] border-2 border-solid rounded-md'
                    placeholder='Password'
                />
                <Link to="/login"><p className='text-sm mb-4 text-blue-500 text-right cursor-pointer hover:underline'>Already have an account?</p></Link>
