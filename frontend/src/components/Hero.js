...
const Hero = ({ src }) => {
  return (
    <div className='flex relative w-full h-96 md:h-[100vh] text-white text-center justify-center md:items-center overflow-hidden uppercase'>
      ...
      <h1 className='absolute flex text-[28px] md:text-4xl lg:text-6xl font-extrabold text-center pt-24 md:pb-60 lg:pb-96 gap-4'>Florida's <span className='text-secondary'>Premier</span> Gym</h1>
      ...
      <Link to="/about" className='absolute flex py-3 px-6 rounded-full bg-primary hover:bg-secondary text-white font-bold text-center gap-4 mt-60 md:mb-8'>Learn More</Link>
    </div>
  )
}
