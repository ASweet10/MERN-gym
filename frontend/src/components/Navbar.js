    ...
    return (
        <header className="flex w-full z-50 justify-between items-center h-24 md:h-16 px-6 md:px-12 py-4 bg-black text-white">
            ...
            <nav className='flex md:hidden justify-center items-center'>
                            ...
                            { user 
                                ? (
                                    ...
                                    <div className='flex flex-col gap-6'>
                                        <Link to="/login" onClick={() => setNavOpen(!navOpen)} className='py-4 px-8 text-xl rounded-md font-bold text-center bg-primary text-white'>Login</Link>
                                        <Link to="/signup" onClick={() => setNavOpen(!navOpen)} className='py-4 px-8 text-xl rounded-md font-bold text-center bg-primary text-white'>Register</Link>
                                    </div>
                                )
                            }
                        </div>
                ...
                <div onClick={() => setNavOpen(!navOpen)} className={`z-50 ${navOpen ? 'fixed pr-6' : ''}`}>
